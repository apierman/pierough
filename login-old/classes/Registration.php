...
class Registration {
    ...
    private     $user_ip		    = "";                       // user's ipaddress
    ...
    private function registerNewUser() {
        ...
        if (strtolower($_POST["captcha"]) != strtolower($_SESSION['captcha'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $this->user_ip        = $this->db_connection->real_escape_string(htmlentities($_POST['user_ip_address'], ENT_QUOTES));
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    $query_new_user_insert = $this->db_connection->query("INSERT INTO users (user_name, user_password_hash, user_email, user_activation_hash, user_ip, user_login_date) VALUES('".$this->user_name."', '".$this->user_password_hash."', '".$this->user_email."', '".$this->user_activation_hash."', ".ip2long($this->user_ip).", now());");
