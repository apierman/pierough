...
class Login {
    ...
    /** @var string $user_ip The user's ip */
    private $user_ip = "";
    ...
    public function __construct() {
		...
		$this->user_ip = $_POST["user_ip_address"];
                ...
                if ($checklogin->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
                        ...
                        if ($result_row->user_active == 1) {
                            ...
                            $_SESSION['user_ip_address'] = $this->user_ip;

                            // declare user id, set the login status to true
                            $this->user_id = $result_row->user_id;
                            $this->user_is_logged_in = true;
                            $this->db_connection->query("UPDATE users SET user_ip = ".ip2long($this->user_ip).", user_login_date = now() WHERE user_id = '$this->user_id';");
