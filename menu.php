...
<html lang="en" >
	...
	<?php if ((isset($_SESSION["user_logged_in"]) && $_SESSION["user_logged_in"] == 1)) {
	     ...
	     echo '<a class="nav-right" href="login/index.php?logout"><img width=35 height=35 src="images/icons/logout-01-gray.png"></a></li>';
	  } else {
	     echo '<a class="nav-right" href="login/index.php"><img width=35 height=35 src="images/icons/login-01-green.png"></a></li>';
	  }
	?>
